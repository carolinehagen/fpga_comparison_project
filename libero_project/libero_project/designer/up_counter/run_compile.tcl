...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"/home/hagen/school/fpga_comparison_project/libero_project/libero_project/synthesis/up_counter.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {/home/hagen/school/fpga_comparison_project/libero_project/libero_project/designer/up_counter} \
    -design up_counter \
    -fam RTG4 \
    -die PA4RT12000L \
    -pkg fcg1657 \
