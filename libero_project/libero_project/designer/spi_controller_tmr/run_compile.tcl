...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"/home/hagen/school/fpga_comparison_project/libero_project/libero_project/synthesis/spi_controller_tmr.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {/home/hagen/school/fpga_comparison_project/libero_project/libero_project/designer/spi_controller_tmr} \
    -design spi_controller_tmr \
    -fam RTG4 \
    -die PA4RT12000L \
    -pkg fcg1657 \
    -merge_pdc 0
